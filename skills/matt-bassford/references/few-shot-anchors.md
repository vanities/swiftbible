# Matt Bassford — Few-shot anchors for AI prompting

When using this skill to generate AI devotionals "in Matt's voice," embed these excerpts as few-shots. Each anchor is chosen because it deploys multiple voice tells from `voice.md` and `late-voice.md` in a tight space, and because it represents one specific register Matt operated in. The full excerpts are kept long enough (200–600 words) that an AI receives the **cadence**, not just the rhetorical moves.

## How to use this file

1. Match the devotional theme to the anchor's "use for" tag.
2. Embed the *Why this anchor works* commentary as instruction, then the excerpt as exemplar.
...
**Why this anchor works:** The flat-confession opener (*"I am. I know it. ALS robs its victims of dignity along with everything else."*), the concrete domestic detail (Boomer the chihuahua eating crumbs from his lap), the OT-shocking-language pivot (Ezekiel 16/23 as theological unflinching), and the final theological hammer (*"We can never be so disgusting that God will cease to love us."*). Demonstrates how late-Matt builds from physical humiliation to grace without leaving the body behind.

**Use for:** verses about grace abounding more (Romans 5–6), spiritual cleansing, God's hatred of sin AND love of sinner, shame-conversion, anything where the AI is tempted to soften God's reaction to sin to make grace land. Matt refuses that softening.

**Do NOT use as anchor for:** topics where the biographical details (incontinence, "stroke stink," dependency on Lauren) don't have a clear analog in the reader's life. The AI shouldn't fabricate parallel biography.
...
**Why this anchor works:** Models the late-voice "I thought I understood this passage. I didn't" move. Cites a literary anchor (Milton) without showing off. Pivots from his own loss to James 5:10's "suffering and patience" with a structural insight (past tense "spoke" / present tense "are"). The closing — *"May I have the courage to take it"* — is one of the most devastating short closings in the archive, and it is a *first-person* prayer-fragment, not a corporate imperative.

**Use for:** verses about waiting, endurance, vocation, weakness as witness, James, 2 Corinthians 12, retirement/aging, end-of-usefulness anxieties, Milton-style consolation. The literary citation works because it's chosen from his actual life (high school memorization), not for show.

**Do NOT use as anchor for:** topics that aren't grappling with the loss of agency. The structural insight about James 5:10 won't work if the devotional isn't actually engaging the verb tenses.
...
>
> Of late, I have been drawn to James' discussion of suffering, and his words in James 5:10 are precisely on point here. He writes about the prophets, those who spoke in the name of the Lord, past tense, and are an example of suffering and patience, present tense.
>
...
**Do NOT use as anchor for:** if the devotional won't actually engage Paul's text. Matt's argument here only works because he's holding Phil 1:21–24 still and turning it over carefully. If the AI tries to use this voice without the textual handle, it will sound mawkish.
...
**Why this anchor works:** The flat-confession opener (*"I hold grudges. It is one of my biggest spiritual failings."*) followed by exact escalation. The parenthetical aside about Lauren. The structural move from self-indictment → biblical handle (1 Cor 13) → terminal-illness perspective → kin-address (*"If you are a member of my grudge-holding tribe…"*). Closes with the *"I get you (Really! I do!)…"* — the most distinctive late-voice closing register. Demonstrates the pivot from "I do this" to "rethink that" without ever sounding preachy.

**Use for:** verses about forgiveness, love-in-action, self-righteousness, perspective at end of life, 1 Corinthians 13, "love does not keep records of wrong." Especially good for any topic where the AI is at risk of preaching at the reader; this anchor models how Matt earns the right to address them directly by indicting himself first.

**Do NOT use as anchor for:** topics where the AI doesn't have something true to confess. The opener ONLY works because Matt is genuinely owning his fault — fabricated confessional openers will sound performative.
...
**Why this anchor works:** The dry-sarcasm-against-secular-piety register (*"a Symbol Of Hope amid devastation and despair, a promise of Better Days Ahead"*). The bullet-list-of-evidence structure (refugees, COVID, ALS). The inverted aphorism in the closing pair: *"This world isn't wonderful, and it never will be. Our Savior is wonderful, and He never will be anything else."* Models how Matt names a cliché ("What a Wonderful World"), refuses it, names what's actually true, and ends on a paired contrast.

**Use for:** verses about the present age vs. age to come, the world's vanity, false hopes, "set your minds on things above," Christ's return as deliverance from a world that won't be repaired. Especially good for topics where the AI might default to a "we can fix it together" frame; Matt refuses that posture.

**Do NOT use as anchor for:** topics that need to be tender about specific suffering. This anchor is flinty, not consoling. Use Anchor 3 (Uselessness) or Anchor 9 (Loyalty) for tender registers.
...
**Why this anchor works:** The concrete domestic detail as on-ramp pushed to the limit — Matt gets ~250 words into the post before it turns devotional. Boomer is described in detail (toilet habits, biting the political pollster, shedding white hair) before the pivot. Then the soft turn through "loyalty matters to me, how much more does our loyalty matter to God." Models the hard-fact-meets-soft-conclusion arc. Closes warmly: *"if loyalty is what He finds in our hearts, we have nothing to fear from Him."*

**Use for:** verses about faithfulness, perseverance, God's delight in his people, Hosea 6:6, 1 Sam-Ruth-style hesed/loyalty themes, "God knows my heart" frame done correctly. Especially good when the AI needs to demonstrate that faith isn't perfection — it's persistence.

**Do NOT use as anchor for:** topics where you don't have a real Boomer-level concrete on-ramp. Don't fabricate a detailed pet biography to set up a devotional. The on-ramp must be true.
...
**Why this anchor works:** Demonstrates the secular-pragmatic-meets-Christ move. Ecclesiastes 12:11 ("all proverbs given by one Shepherd") as a frame for taking a Bezos saying seriously, then the pivot to *"Jeff Bezos didn't get eleventy hundred billion dollars by thinking about what he wanted."* The italicized scorn (*The Price Is Right*). Closes with the verdict-style imperative triplet: *"Create. Give. Lose. The world will think you're an idiot, but God won't."* Models the late-voice 3-imperative-then-tag closing.

**Use for:** verses about service, generosity, kingdom-economics, "lose your life to find it," vocation as creating-for-others. Good for topics that need the world's wisdom acknowledged before being inverted.

**Do NOT use as anchor for:** topics about humility-as-passivity. Matt's "create" verb is decisively active.
...
**Why this anchor works:** Critical pre-ALS anchor for the heaven-as-relational theme. The Bible-geek-friends opener, the Sartre inversion, the introvert self-disclosure, the congregation specificity (*"The congregation at Joliet likes to laugh at me…"*). Models the pre-ALS register: longer, more analytical, but with the same voice fingerprint. Demonstrates that the inverted-aphorism move predates ALS by 6 years.

**Use for:** verses about heaven, eternal fellowship, John 14, Revelation 21–22, 1 Thess 4:17. Critical anchor — heaven-themed devotionals must engage Matt's relational frame, not pearly-gates real-estate frame.

**Do NOT use as anchor for:** topics that don't need the analytical buildup. Pre-ALS Matt takes longer to land a point. If the devotional needs to be 200 words, this anchor's pace is wrong.

> In the year or so since I enrolled as a full-fledged Bible geek, I've come to enjoy having a set of Bible-geek friends online who (mostly) do not hail from churches of Christ. They're generally quite religious, though, so they link to a number of religious posts and articles that I would never otherwise have seen. Some of these I absently dismiss, but others make me think.
>
> One such post that I read recently was the provocatively titled "10 Reasons Christian Heaven Would Actually Be Hell". Though I think the author's view of heaven is a little slanted (too much time taking Revelation literally, for instance), many of the questions he raises are legitimate. Won't everything be the same in heaven? Isn't it going to be kind of gaudy? How will those in heaven handle the suffering of those in hell? And so on. The author uses these questions to construct a vision of heaven as a sterile prison which is scarcely preferable to an eternity of torment.
>
> Even as I was reading the article, though, I felt an unease with the author's analysis that I couldn't quite put my finger on. After thinking about it, I realized what the problem was. The post focused exclusively on what the Bible says about heaven without considering at all what the Bible says about Christianity.
>
> More than anything else, the Christianity of the Bible is about relationships. [...]
>
> These three principles lead to a focus on others that non-Christians sometimes struggle to comprehend, especially in our individualistic, fragmented society. I've read that on average, Americans invite others into their homes for a meal about once a year. My wife and I, by contrast, entertain regularly, and the biggest limiting factor on our hospitality is that non-Christians are often suspicious of dinner invitations. No, we're not going to lock you in our house and give you the hard sell. We just want to get to know you better. Besides, as millions of mothers know, food is a wonderful way to express love.
>
> Christians shouldn't want distance. They shouldn't want space. Instead, they should want to be immersed in the lives of others, especially other Christians. Now, I'm certainly not going to claim that I'm thrilled with everything that every one of my brethren ever says or does, but it is still true that my relationships with them are the defining feature of my earthly existence, and I find that it makes my life rich and rewarding in ways that my introverted soul would never have realized on its own.
>
> [...]
>
> Heaven to me, then, isn't about pearly gates and golden streets, however metaphorical they may be. Instead, it is an opportunity to finally and fully achieve my greatest longings. If all my life, I have earnestly sought for God and for other Christians, then what better reward can there be than to spend eternity with all of them?
>
> The congregation at Joliet likes to laugh at me because I constantly identify different passages as "one of my favorites," but one of my favoritest of all is 1 Thessalonians 4:17. It reads, "Then we who are alive and remain will be caught up together with them in the clouds to meet the Lord in the air, and so we shall always be with the Lord." (NASB) Sartre was dead wrong. Hell isn't other people. Heaven is. It's something that every true disciple understands, and it's something that no unbeliever can ever grasp.

## Posts that should NOT be used as few-shot anchors

These are valuable for research but dangerous as exemplars because they would lead an AI into fabricating biography or contextually narrow CoC distinctives.
...
1. **Quote Matt directly with attribution** — citing the post by filename + date, using *italics or block-quote*, never blending his words with AI-generated continuations.
2. **Translate the *moves* without the *content*** — instead of "my dog Boomer," the AI writes a comparable on-ramp from the user's actual life or a generic shared experience, with a similar arc but different specifics.

**The unsafe path:** the AI generates "Matt-flavored" prose that names Lauren, Marky, ALS, Joliet, etc. as if Matt is speaking. This would falsify his record and put words in his mouth he never wrote. Refuse this mode.
