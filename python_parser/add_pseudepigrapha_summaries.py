...
PSEUDEPIGRAPHA_DATA: dict[str, dict[str, dict]] = {
    # 1 Clement (65 chapters) — letter from the church at Rome to the
    # church at Corinth, traditionally attributed to Clement of Rome
    # (c. 96 CE). One of the earliest non-canonical Christian writings,
    # addressing a schism in which the Corinthian church had deposed
    # its rightful presbyters. Each chapter is one paragraph; we anchor
    # a single whole-chapter summary at v1.
    "1 Clement": {
        "1":  {"title": "Greeting from the church at Rome to Corinth", "passages": [{"startVerse": 1, "endVerse": None, "title": "The opening greeting and a regretful note that internal trouble has prevented Rome from writing sooner."}]},
        "2":  {"title": "Praise for Corinth's former humility and order", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement recalls the Corinthians' past virtues — their humility, their generosity, their willingness to forgive."}]},
        "3":  {"title": "How prosperity gave rise to envy and schism", "passages": [{"startVerse": 1, "endVerse": None, "title": "Once Corinth grew comfortable, jealousy and contention arose, and the unworthy began to rise up against the elders."}]},
        "4":  {"title": "Old Testament examples of envy from Cain to Saul", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement recites a chain of biblical victims of envy — Abel, Jacob, Joseph, Moses, David — to show its destructive power."}]},
        "5":  {"title": "Recent examples: the deaths of Peter and Paul", "passages": [{"startVerse": 1, "endVerse": None, "title": "Bringing the lesson up to his own generation, Clement names Peter and Paul as having suffered through envy and fought the good fight."}]},
        "6":  {"title": "The great multitude of recent Christian martyrs", "passages": [{"startVerse": 1, "endVerse": None, "title": "Many other Christians, including women, have endured cruel deaths in this same generation through envy and persecution."}]},
        "7":  {"title": "A summons to common repentance", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement reminds his hearers — and himself — that they are all in the same arena and must repent together."}]},
        "8":  {"title": "The prophetic call to repentance", "passages": [{"startVerse": 1, "endVerse": None, "title": "He cites the prophets and the Lord's own oath that he desires not the death of the sinner but his repentance."}]},
        "9":  {"title": "Examples of obedience: Enoch and Noah", "passages": [{"startVerse": 1, "endVerse": None, "title": "Enoch was translated for his obedience and Noah preached repentance to the world; both serve as patterns to follow."}]},
        "10": {"title": "Abraham, the friend of God", "passages": [{"startVerse": 1, "endVerse": None, "title": "Abraham's repeated obedience — leaving his country, offering Isaac — shows the rewards of faithful obedience."}]},
        "11": {"title": "Lot saved out of Sodom", "passages": [{"startVerse": 1, "endVerse": None, "title": "Lot's hospitality and godliness preserved him while Sodom perished; his wife stands as a warning against doubting hearts."}]},
        "12": {"title": "Rahab the harlot saved by faith and hospitality", "passages": [{"startVerse": 1, "endVerse": None, "title": "Rahab is held up for her faith in receiving the spies, and the scarlet cord is read as a symbol of redemption by Christ's blood."}]},
        "13": {"title": "A call to humility from the words of the Lord", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement quotes the Beatitudes-style sayings of Jesus on humility and gentleness as the rule for the church's common life."}]},
        "14": {"title": "Obey God rather than the leaders of sedition", "passages": [{"startVerse": 1, "endVerse": None, "title": "He warns that following the schismatic faction means disobeying God himself; the wicked will be cut off from the land."}]},
        "15": {"title": "Cleave to the truly peaceable, not the false", "passages": [{"startVerse": 1, "endVerse": None, "title": "Some claim peace with their lips but their hearts are far from God; cleave instead to those who cultivate genuine peace."}]},
        "16": {"title": "Christ the supreme example of humility", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement quotes Isaiah 53 at length to show that the Lord himself came in lowliness, not in pomp, as the model for all believers."}]},
        "17": {"title": "Imitate the prophets — Elijah, Elisha, Ezekiel", "passages": [{"startVerse": 1, "endVerse": None, "title": "The prophets walked in goat-skins and sheep-skins, despised in the world; their humility is the church's pattern."}]},
        "18": {"title": "David's penitence in Psalm 51", "passages": [{"startVerse": 1, "endVerse": None, "title": "David, the man after God's own heart, prayed in deep repentance — Clement quotes Psalm 51 in full as the model of contrition."}]},
        "19": {"title": "These examples have improved every generation", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement insists that the chain of humble examples is a moral inheritance for every age, including the present."}]},
        "20": {"title": "The peaceful order of the natural world", "passages": [{"startVerse": 1, "endVerse": None, "title": "Heavens, sun, moon, stars, seasons, and creatures all move in peaceful order at God's command — a rebuke to human strife."}]},
        "21": {"title": "Walk worthy of God's many kindnesses", "passages": [{"startVerse": 1, "endVerse": None, "title": "Take heed lest the multiplied mercies of God become the ground of our condemnation; walk in love and unity."}]},
        "22": {"title": "The faith that Christ teaches us by the Spirit", "passages": [{"startVerse": 1, "endVerse": None, "title": "Christ himself addresses the church through the psalms, calling for the fear of the Lord and the love of life."}]},
        "23": {"title": "God's compassion and the danger of double-mindedness", "passages": [{"startVerse": 1, "endVerse": None, "title": "The all-merciful Father shows favor to the simple-hearted; Clement warns against double-mindedness and impatience."}]},
        "24": {"title": "Resurrection — the seasons and the seed", "passages": [{"startVerse": 1, "endVerse": None, "title": "The constant cycle of seed dying and rising, and of day succeeding night, witnesses to the resurrection that Christ has secured."}]},
        "25": {"title": "The phoenix as a sign of the resurrection", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement appeals to the legendary phoenix of Arabia as a natural sign that God can raise the dead."}]},
        "26": {"title": "How much more shall God raise his servants", "passages": [{"startVerse": 1, "endVerse": None, "title": "If a single bird is so renewed by God's hand, how much more those who have served him in faith — buttressed with psalm citations."}]},
        "27": {"title": "Hope grounded in God's faithfulness", "passages": [{"startVerse": 1, "endVerse": None, "title": "He who has commanded us not to lie cannot himself lie; nothing is impossible with him, and our hope is therefore secure."}]},
        "28": {"title": "Fear of God since all is seen and heard", "passages": [{"startVerse": 1, "endVerse": None, "title": "Because nothing is hidden from God, we must forsake evil works and live in his sight as those expecting judgment."}]},
        "29": {"title": "We are the portion of the Holy One", "passages": [{"startVerse": 1, "endVerse": None, "title": "Citing Deuteronomy, Clement reminds the church that they are God's own portion and ought to draw near in holiness."}]},
        "30": {"title": "Holiness practical: avoid sins of the tongue and body", "passages": [{"startVerse": 1, "endVerse": None, "title": "As people set apart for God, the Corinthians must shun gossip, drunkenness, and impurity, clothing themselves in unity and humility."}]},
        "31": {"title": "Means of obtaining God's blessing", "passages": [{"startVerse": 1, "endVerse": None, "title": "Look back at the patriarchs: they obtained blessing through faith and obedience, not through their own ambition."}]},
        "32": {"title": "All blessings come from Abraham's seed", "passages": [{"startVerse": 1, "endVerse": None, "title": "Priests, Levites, and the Lord himself according to the flesh have come from Abraham — every gift is rooted in his obedience."}]},
        "33": {"title": "We are not to grow slothful in well-doing", "passages": [{"startVerse": 1, "endVerse": None, "title": "Justification by faith does not free us from good works; the Creator himself models tireless activity for our imitation."}]},
        "34": {"title": "The diligent servant approaches with confidence", "passages": [{"startVerse": 1, "endVerse": None, "title": "The diligent worker can look his master in the face; we should be eager and confident in the work appointed to us."}]},
        "35": {"title": "How blessed are the gifts of God", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement enumerates the gifts of God — life, righteousness, truth, faith, self-control — that await the obedient."}]},
        "36": {"title": "Jesus Christ, the great High Priest", "passages": [{"startVerse": 1, "endVerse": None, "title": "Through Christ, the Lord opens the heights of heaven to us; Clement quotes Hebrews-style passages on his high-priestly ministry."}]},
        "37": {"title": "Christians as soldiers of Christ", "passages": [{"startVerse": 1, "endVerse": None, "title": "Drawing on military discipline, Clement urges that every member fulfill his rank and follow the order set down by the commander."}]},
        "38": {"title": "Mutual subjection in the body of Christ", "passages": [{"startVerse": 1, "endVerse": None, "title": "Strong and weak, rich and poor, wise and ignorant — each has need of the other and ought to give thanks for the other."}]},
        "39": {"title": "The folly of self-exaltation", "passages": [{"startVerse": 1, "endVerse": None, "title": "Citing Job 4, Clement mocks the proud who exalt themselves; their boasting is destroyed in a moment by the Lord."}]},
        "40": {"title": "All things in their proper order", "passages": [{"startVerse": 1, "endVerse": None, "title": "God has fixed times, seasons, and orders for sacrifice and service; we must do all things in the order he has appointed."}]},
        "41": {"title": "The order of the temple as an analogy", "passages": [{"startVerse": 1, "endVerse": None, "title": "In Israel sacrifices were offered only at the appointed place by the appointed persons; the church's worship needs the same order."}]},
        "42": {"title": "The apostolic chain: God → Christ → apostles → bishops", "passages": [{"startVerse": 1, "endVerse": None, "title": "Christ was sent by God, the apostles by Christ, and the apostles in turn appointed bishops and deacons in every place."}]},
        "43": {"title": "Moses' rod, Aaron's choice, and divine appointment", "passages": [{"startVerse": 1, "endVerse": None, "title": "As God settled the priesthood by the budding of Aaron's rod, so the apostles arranged the orderly succession of ministers."}]},
        "44": {"title": "It is wicked to expel rightly appointed presbyters", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement's central charge: the apostles foresaw strife about the office and provided rules; deposing blameless presbyters is grave sin."}]},
        "45": {"title": "Look at the Scriptures for examples of the persecuted righteous", "passages": [{"startVerse": 1, "endVerse": None, "title": "Daniel and the three young men suffered at the hands of the godless, but God vindicated them; the Corinthian rebels mirror the persecutors."}]},
        "46": {"title": "Cleave to the holy and avoid the perverse", "passages": [{"startVerse": 1, "endVerse": None, "title": "Scripture teaches us to attach ourselves to the holy; one schism in the body wounds the entire body of Christ."}]},
        "47": {"title": "Recall Paul's first epistle to you", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement reminds the Corinthians that even in Paul's day they were given to factions; they should be ashamed to repeat the sin."}]},
        "48": {"title": "Put an end to the contention quickly", "passages": [{"startVerse": 1, "endVerse": None, "title": "Let the Corinthians fall down before the Lord with tears and beg his mercy; the gates of righteousness stand open to repentance."}]},
        "49": {"title": "The greatness of love", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement begins his hymn to love — love that bears all things, love which the saints have always borne and through which the saints are perfected."}]},
        "50": {"title": "Love perfects the saints", "passages": [{"startVerse": 1, "endVerse": None, "title": "He continues praising love as the only sufficient cover for sin; only those gathered into love will be made manifest in the kingdom."}]},
        "51": {"title": "Confess the sin and seek forgiveness", "passages": [{"startVerse": 1, "endVerse": None, "title": "Implore forgiveness for past faults; the leaders of sedition should consider the common hope rather than their own pride."}]},
        "52": {"title": "God needs nothing but our confession", "passages": [{"startVerse": 1, "endVerse": None, "title": "The Lord requires no sacrifice but a heart confessing — quotation of the psalms on the offering of thanksgiving."}]},
        "53": {"title": "Moses' intercession as a model", "passages": [{"startVerse": 1, "endVerse": None, "title": "When Israel sinned at Sinai, Moses begged that his own name be blotted out so the people might be spared — the perfect picture of selfless love."}]},
        "54": {"title": "The willingness to depart for the sake of peace", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement appeals: let any noble Christian whose presence has caused contention voluntarily withdraw, that the body may be at peace."}]},
        "55": {"title": "Pagan and biblical examples of self-sacrifice", "passages": [{"startVerse": 1, "endVerse": None, "title": "Even pagan kings and women like Esther and Judith have laid down their lives for their people — Christians ought to do no less."}]},
        "56": {"title": "Pray for the fallen", "passages": [{"startVerse": 1, "endVerse": None, "title": "Pray for those who have stumbled into sin that they may receive correction with meekness from God's hand."}]},
        "57": {"title": "Clement's direct warning to the schismatics", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement directly addresses the leaders of the sedition, calling them to submit to the presbyters and bend the knees of their hearts."}]},
        "58": {"title": "Yield submission to God's holy name", "passages": [{"startVerse": 1, "endVerse": None, "title": "He sets life and death before them: those who obey will be enrolled with the holy, those who refuse will inherit ruin."}]},
        "59": {"title": "Clement's intercessory prayer begins", "passages": [{"startVerse": 1, "endVerse": None, "title": "Should any disobey the words sent through this letter, let them know they sin against God; Clement begins a great intercessory prayer."}]},
        "60": {"title": "Petition for forgiveness and blessing on the church", "passages": [{"startVerse": 1, "endVerse": None, "title": "He prays that God forgive their iniquities, deliver them from those who hate without cause, and lead them to walk in holiness."}]},
        "61": {"title": "Prayer for civil rulers and earthly authorities", "passages": [{"startVerse": 1, "endVerse": None, "title": "He prays for the rulers and governors that God would guide them in peace and grant them the wisdom to use the authority given to them."}]},
        "62": {"title": "Summary of the matters discussed in the letter", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement reviews what he has written: how a godly life is built, how repentance restores, and how love and faith are inseparable."}]},
        "63": {"title": "Clement urges submission and humility", "passages": [{"startVerse": 1, "endVerse": None, "title": "He calls on the Corinthians to bend the neck and accept correction, that they may attain the goal set before them."}]},
        "64": {"title": "Final blessing on the elect", "passages": [{"startVerse": 1, "endVerse": None, "title": "A closing benediction that God, ruler of all spirits, may grant his elect every gift of grace through the Lord Jesus Christ."}]},
        "65": {"title": "Send the messengers back in peace", "passages": [{"startVerse": 1, "endVerse": None, "title": "Clement asks that the bearers of the letter — Claudius Ephebus, Valerius Bito, and Fortunatus — be sent home swiftly with news of restored peace."}]},
    },
