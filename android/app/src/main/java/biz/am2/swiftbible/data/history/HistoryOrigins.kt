...
object OriginsHistory {

    val originsTimeline = HistoryArticle(
        id = "origins-timeline",
        ...
        estimatedMinutes = 5,
        body = listOf(
            BodyBlock.Paragraph("The New Testament was not handed down as a finished book. Its 27 documents were written across roughly the second half of the first century, then circulated, copied, debated, and gradually recognized as Scripture by churches across the Roman Empire and beyond. The process of formal recognition stretched over three centuries."),
            BodyBlock.Heading("What was written, and when"),
            BodyBlock.Paragraph("The earliest New Testament writings are most likely some of Paul's letters, with 1 Thessalonians often dated to around 50 AD. The four Gospels followed: most scholars place Mark in the late 60s, Matthew and Luke in the 70s or 80s, and John near the end of the first century. Acts, Hebrews, the General Epistles, and Revelation fill out the corpus by roughly 95 AD."),
            BodyBlock.Heading("How they spread"),
            BodyBlock.Paragraph("Each text was written for a specific audience — a church, a person, a network of communities — but copies travelled. By the early 100s, churches in Rome, Antioch, and Asia Minor were trading manuscripts. Bishops cited multiple Gospels and Pauline letters as authoritative without yet defining a fixed list."),
            BodyBlock.Heading("Pressure to define a list"),
            BodyBlock.Paragraph("The catalyst for a formal canon came partly from heretical teachers. Around 140 AD, Marcion of Sinope published his own narrow canon — a single edited Gospel and ten Pauline letters — rejecting the Old Testament entirely. The wider church now had to articulate which writings it considered Scripture and why."),
            BodyBlock.Timeline(listOf(
    ...
    sources = listOf(
        HistorySource(title = "Development of the New Testament canon", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Development_of_the_New_Testament_canon", note = null),
        HistorySource(title = "Festal Letter 39", author = "Athanasius", kind = SourceKind.PRIMARY, url = null, note = "Available in English at newadvent.org/fathers and ccel.org."),
        HistorySource(title = "The Canon of the New Testament: Its Origin, Development, and Significance", author = "Bruce M. Metzger", kind = SourceKind.SCHOLARLY, url = null, note = "Oxford, 1987 — standard scholarly reference."),
        HistorySource(title = "The Canon of Scripture", author = "F. F. Bruce", kind = SourceKind.SCHOLARLY, url = null, note = "InterVarsity, 1988 — accessible Protestant treatment.")
    ),
    related = listOf("origins-canon-process", "origins-disputed-books", "origins-marcion")
    )



    val originsCanonProcess = HistoryArticle(
        ...
        estimatedMinutes = 5,
        body = listOf(
            BodyBlock.Paragraph("When ancient Christians evaluated whether a writing belonged in Scripture, they generally applied three overlapping tests: apostolic origin, widespread use, and consistency with the rule of faith. None of these criteria appears as a formal checklist in any single early document, but they show up consistently across the writings of figures like Eusebius, Origen, Athanasius, and Augustine."),
            BodyBlock.Heading("Apostolic origin"),
            BodyBlock.Paragraph("A book's connection to an apostle or apostolic associate weighed heavily. The four Gospels were attributed to Matthew (an apostle), Mark (an associate of Peter), Luke (an associate of Paul), and John (an apostle). Pauline authorship was claimed for the thirteen letters bearing his name. Hebrews was disputed in part because its author was unnamed."),
            BodyBlock.Heading("Widespread use"),
            BodyBlock.Paragraph("Writings already read in worship across multiple regions had a strong claim. A book accepted only in one corner of the empire could be a local treasure, not Scripture. The four Gospels and the major Pauline letters met this test almost universally by the second century. Other writings, however valuable, did not circulate as broadly."),
            BodyBlock.Heading("Rule of faith"),
            BodyBlock.Paragraph("Texts also had to align with what the church already taught. Documents that contradicted the apostolic preaching or promoted theological systems considered heretical were rejected. This is why Gnostic writings such as the Gospel of Thomas and the Gospel of Judas — though sometimes attributed to apostles — never made the canon. Their underlying theology was incompatible with mainstream Christian belief."),
            BodyBlock.Heading("Recognition, not invention"),
            BodyBlock.Paragraph("It is important to distinguish between recognition and invention. Most historians agree that fourth-century church councils did not create a canon out of thin air; they ratified a consensus that had already taken shape over the previous two centuries. Lists like the Muratorian Fragment (c. 170 AD) and the canon described by Origen (c. 240 AD) show that the broad outlines were settled long before any formal council."),
            BodyBlock.Heading("Different traditions, different deliberations"),
            BodyBlock.Paragraph("Recognition was not perfectly synchronized everywhere. The Syriac-speaking church, for example, used a four-Gospel harmony called the Diatessaron well into the fifth century before adopting the four separate Gospels. The Ethiopian Orthodox tradition kept a slightly larger canon. The basic 27-book core, however, came to be shared by every major Christian tradition.")
        ),
    pullQuotes = listOf(
        PullQuote(
    ...
    sources = listOf(
        HistorySource(title = "Ecclesiastical History, Book 3, Chapter 25", author = "Eusebius of Caesarea", kind = SourceKind.PRIMARY, url = null, note = "Available in English at newadvent.org/fathers and ccel.org."),
        HistorySource(title = "Biblical canon", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Biblical_canon", note = null),
        ...
        HistorySource(title = "Muratorian Fragment", author = null, kind = SourceKind.PRIMARY, url = "https://en.wikipedia.org/wiki/Muratorian_fragment", note = "c. 170 AD canon list.")
    ),
    related = listOf("origins-timeline", "origins-disputed-books")
    )



    val originsDisputedBooks = HistoryArticle(
    ...
    sources = listOf(
        HistorySource(title = "Ecclesiastical History 3.25", author = "Eusebius of Caesarea", kind = SourceKind.PRIMARY, url = null, note = null),
        HistorySource(title = "Antilegomena", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Antilegomena", note = null),
        HistorySource(title = "Book of Revelation", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Book_of_Revelation", note = null),
        HistorySource(title = "The Canon of the New Testament", author = "Bruce M. Metzger", kind = SourceKind.SCHOLARLY, url = null, note = "Oxford, 1987.")
    ),
    related = listOf("origins-canon-process", "origins-timeline")
    )



    val originsMarcion = HistoryArticle(
        id = "origins-marcion",
    ...
    sources = listOf(
        HistorySource(title = "Against Marcion", author = "Tertullian", kind = SourceKind.PRIMARY, url = null, note = "Five books; available at newadvent.org/fathers."),
        HistorySource(title = "Marcion of Sinope", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Marcion_of_Sinope", note = null),
        HistorySource(title = "Marcionism", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Marcionism", note = null),
        HistorySource(title = "Marcion: The Gospel of the Alien God", author = "Adolf von Harnack", kind = SourceKind.SCHOLARLY, url = null, note = "1921; English trans. Labyrinth Press, 1990.")
    ),
    related = listOf("origins-timeline", "origins-canon-process")
    )


    val origins = HistorySection(
        id = "origins",
        title = "Origins of the New Testament",
        subtitle = "How 27 documents written across 50 years became Scripture.",
        era = "50 — 397 AD",
        emoji = "✝️",
        articles = listOf(originsTimeline, originsCanonProcess, originsDisputedBooks, originsMarcion)
    )
}
