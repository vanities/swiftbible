...
object IntertestamentalHistory {

    val intertestMaccabees = HistoryArticle(
    ...
    sources = listOf(
        HistorySource(title = "Hellenistic Judaism", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Hellenistic_Judaism", note = null),
        HistorySource(title = "Maccabean Revolt", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Maccabean_Revolt", note = null),
        HistorySource(title = "1 Maccabees and 2 Maccabees", author = null, kind = SourceKind.PRIMARY, url = null, note = "Apocrypha / deuterocanonical."),
        ...
        HistorySource(title = "The Jews in the Greek Age", author = "Elias Bickerman", kind = SourceKind.SCHOLARLY, url = null, note = "Harvard University Press, 1988.")
    ),
    related = listOf("israel-return", "intertest-roman", "intertest-sects")
    )



    val intertestRoman = HistoryArticle(
        id = "intertest-roman",
        title = "Roman Era",
    ...
    sources = listOf(
        HistorySource(title = "Judaea (Roman province)", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Judaea_(Roman_province)", note = null),
        ...
        HistorySource(title = "First Jewish–Roman War", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/First_Jewish%E2%80%93Roman_War", note = null),
        HistorySource(title = "The Jewish War and Antiquities of the Jews", author = "Flavius Josephus", kind = SourceKind.PRIMARY, url = null, note = "Eyewitness historian, late 1st century AD."),
        HistorySource(title = "Rome and Jerusalem: The Clash of Ancient Civilizations", author = "Martin Goodman", kind = SourceKind.SCHOLARLY, url = null, note = "Knopf, 2007.")
    ),
    related = listOf("intertest-maccabees", "intertest-sects", "israel-return")
    )



    val intertestSects = HistoryArticle(
        id = "intertest-sects",
        title = "Jewish Sects",
    ...
    sources = listOf(
        HistorySource(title = "Pharisees", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Pharisees", note = null),
        HistorySource(title = "Sadducees", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Sadducees", note = null),
        HistorySource(title = "Essenes", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Essenes", note = null),
        HistorySource(title = "Zealots", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Zealots_(Judea)", note = null),
        HistorySource(title = "Antiquities of the Jews, Book 18", author = "Flavius Josephus", kind = SourceKind.PRIMARY, url = null, note = "Describes the four major Jewish 'philosophies' of the period."),
        HistorySource(title = "Judaism: Practice and Belief, 63 BCE–66 CE", author = "E. P. Sanders", kind = SourceKind.SCHOLARLY, url = null, note = "Trinity Press, 1992.")
    ),
    related = listOf("intertest-roman", "hebrew-dead-sea", "early-fathers")
    )


    val intertestamental = HistorySection(
        id = "intertestamental",
        title = "The Intertestamental Period",
        subtitle = "Greek conquest, Maccabean revolt, Roman occupation — the world Jesus was born into.",
        era = "332 BC — 70 AD",
        emoji = "⏳",
        articles = listOf(intertestMaccabees, intertestRoman, intertestSects)
    )
}
