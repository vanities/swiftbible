...
object EarlyChurchHistory {

    val earlyFathers = HistoryArticle(
        id = "early-fathers",
    ...
    sources = listOf(
        HistorySource(title = "Apostolic Fathers", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Apostolic_Fathers", note = null),
        HistorySource(title = "Letters of Ignatius of Antioch", author = "Ignatius of Antioch", kind = SourceKind.PRIMARY, url = null, note = "Available at newadvent.org/fathers and ccel.org."),
        HistorySource(title = "The Didache", author = null, kind = SourceKind.PRIMARY, url = null, note = "Earliest known Christian church manual; English at earlychristianwritings.com."),
        HistorySource(title = "The Apostolic Fathers: Greek Texts and English Translations", author = "Michael W. Holmes (ed.)", kind = SourceKind.SCHOLARLY, url = null, note = "Baker Academic, 3rd ed., 2007.")
    ),
    related = listOf("early-apologists", "early-bishops", "origins-canon-process")
    )



    val earlyApologists = HistoryArticle(
        id = "early-apologists",
    ...
    sources = listOf(
        HistorySource(title = "First Apology", author = "Justin Martyr", kind = SourceKind.PRIMARY, url = null, note = "Available at newadvent.org/fathers."),
        HistorySource(title = "Against Heresies", author = "Irenaeus of Lyons", kind = SourceKind.PRIMARY, url = null, note = "Five books; available at newadvent.org/fathers."),
        HistorySource(title = "Apologetics", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Apologetics", note = null),
        HistorySource(title = "The Early Church", author = "Henry Chadwick", kind = SourceKind.SCHOLARLY, url = null, note = "Penguin, rev. ed. 1993.")
    ),
    related = listOf("early-fathers", "early-bishops")
    )



    val earlyBishops = HistoryArticle(
        id = "early-bishops",
    ...
    sources = listOf(
        HistorySource(title = "Letters of Ignatius", author = "Ignatius of Antioch", kind = SourceKind.PRIMARY, url = null, note = "Especially Smyrnaeans, Ephesians, Magnesians, Trallians."),
        HistorySource(title = "Against Heresies, Books 3.1–3.5", author = "Irenaeus of Lyons", kind = SourceKind.PRIMARY, url = null, note = null),
        HistorySource(title = "Apostolic succession", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Apostolic_succession", note = null),
        HistorySource(title = "From Apostles to Bishops: The Development of the Episcopacy in the Early Church", author = "Francis A. Sullivan", kind = SourceKind.SCHOLARLY, url = null, note = "Newman Press, 2001.")
    ),
    related = listOf("early-fathers", "practices-government", "denominations-restoration")
    )



    val earlyEucharist = HistoryArticle(
        id = "early-eucharist",
    ...
    BodyBlock.Heading("Where things stand"),
    BodyBlock.Paragraph("Today, Catholic, Orthodox, and many Anglican and Lutheran churches retain a strong sacramental theology of the Eucharist. Reformed and many Methodist churches typically affirm a spiritual presence. Most Baptist, non-denominational, and Restoration churches teach a memorial view. The differences are real, but every tradition agrees that the Lord's Supper is central to Christian worship and is something Christ commanded his church to do.")
    ),
    pullQuotes = listOf(
        PullQuote(
    ...
    sources = listOf(
        HistorySource(title = "Letters of Ignatius", author = "Ignatius of Antioch", kind = SourceKind.PRIMARY, url = null, note = null),
        HistorySource(title = "First Apology, ch. 66", author = "Justin Martyr", kind = SourceKind.PRIMARY, url = null, note = null),
        HistorySource(title = "The Didache, chs. 9–10, 14", author = null, kind = SourceKind.PRIMARY, url = null, note = null),
        ...
        HistorySource(title = "Berengar of Tours", author = null, kind = SourceKind.ENCYCLOPEDIA, url = "https://en.wikipedia.org/wiki/Berengar_of_Tours", note = null)
    ),
    related = listOf("early-fathers", "practices-lords-supper")
    )


    val earlyChurch = HistorySection(
        id = "early-church",
        title = "The Early Church",
        subtitle = "Bishops, apologists, and a faith spreading under empire.",
        era = "100 — 500 AD",
        emoji = "⛪",
        articles = listOf(earlyFathers, earlyApologists, earlyBishops, earlyEucharist)
    )
}
