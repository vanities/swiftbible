...
//  swiftbible
//
//  Section 3 — The Great Splits.
//

import Foundation

extension HistorySection {
    static let splits = HistorySection(
        id: "splits",
...
extension HistoryArticle {
    static let splitsChalcedon = HistoryArticle(
        id: "splits-chalcedon",
        ...
        estimatedMinutes: 5,
        body: [
            .paragraph("Six centuries before the East-West Schism of 1054, an earlier and equally important rupture took place at the Council of Chalcedon in 451 AD. The dispute centered on a question that had occupied Christian theologians for decades: how exactly are the divine and human natures of Christ related?"),
            .heading("The question"),
            .paragraph("All sides agreed that Jesus Christ is both fully God and fully human. They disagreed on how to articulate the relationship between his divinity and humanity in technical theological language. Two schools of thought, associated with the great Eastern cities of Antioch and Alexandria, had been debating the matter for nearly a century."),
            .heading("The Chalcedonian Definition"),
            .paragraph("The Council of Chalcedon, attended by some 520 bishops, adopted a formula stating that Christ is 'one and the same Son… acknowledged in two natures, without confusion, without change, without division, without separation.' This phrasing — sometimes called the dyophysite (two-nature) formula — became the Christological standard for the churches of Rome and Constantinople, and through them for nearly all later Western Christianity."),
            .heading("Who left"),
            ...
            .heading("The Oriental Orthodox today"),
            .paragraph("The churches that rejected Chalcedon are today known collectively as the Oriental Orthodox Communion. They include:"),
            .list([
        ...
        sources: [
            HistorySource(title: "Council of Chalcedon", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Council_of_Chalcedon", note: nil),
            HistorySource(title: "Oriental Orthodoxy", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Oriental_Orthodox_Churches", note: nil),
            HistorySource(title: "The Definition of Chalcedon", author: nil, kind: .primary, url: nil, note: "Conciliar text, 451 AD."),
            HistorySource(title: "Christ in Eastern Christian Thought", author: "John Meyendorff", kind: .scholarly, url: nil, note: "St. Vladimir's Seminary Press, 1969.")
        ],
        related: ["splits-1054", "denominations-comparison"]
    )

    static let splits1054 = HistoryArticle(
        id: "splits-1054",
        ...
        body: [
            ...
            .paragraph("The 1054 events were the climax of pressures that had been building for centuries. The Roman Empire had effectively split into two halves — the Latin-speaking West, increasingly dominated by Rome, and the Greek-speaking East, centered on Constantinople. Language, culture, liturgy, theology, and politics drifted apart. By 1054, two profoundly different Christian cultures could not always understand each other."),
            .heading("The theological flashpoints"),
            .list([
        ...
        sources: [
            HistorySource(title: "East–West Schism", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/East%E2%80%93West_Schism", note: nil),
            HistorySource(title: "Filioque", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Filioque", note: nil),
            HistorySource(title: "The Eastern Schism", author: "Steven Runciman", kind: .scholarly, url: nil, note: "Oxford, 1955."),
            HistorySource(title: "East and West: The Making of a Rift in the Church", author: "Henry Chadwick", kind: .scholarly, url: nil, note: "Oxford, 2003.")
        ],
        related: ["splits-chalcedon", "splits-reformation", "denominations-comparison"]
    )

    static let splitsReformation = HistoryArticle(
        ...
        body: [
            ...
            .heading("Multiple reformations"),
            .paragraph("The Reformation was not a single movement. Within a generation, several distinct streams emerged:"),
            .list([
        ...
        sources: [
            HistorySource(title: "Reformation", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Reformation", note: nil),
            HistorySource(title: "Martin Luther", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Martin_Luther", note: nil),
            HistorySource(title: "Five solae", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Five_solae", note: nil),
            HistorySource(title: "The Reformation: A History", author: "Diarmaid MacCulloch", kind: .scholarly, url: nil, note: "Penguin, 2003."),
            HistorySource(title: "Luther: Man Between God and the Devil", author: "Heiko A. Oberman", kind: .scholarly, url: nil, note: "Yale University Press, 1989.")
        ],
        related: ["splits-1054", "denominations-comparison", "denominations-restoration"]
    )
}
