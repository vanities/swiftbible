//
//  HistoryDenominations.swift
//  swiftbible
//
//  Section 4 — Denominations Today.
//

import Foundation

extension HistorySection {
    static let denominations = HistorySection(
        id: "denominations",
        ...
        era: "Modern",
        articles: [
            .denominationsComparison,
            .denominationsOverview,
            .denominationsRestoration
        ]
    )
}

extension HistoryArticle {
    static let denominationsComparison = HistoryArticle(
        ...
        body: [
            ...
            .heading("Where the lines are drawn"),
            .paragraph("Several axes recur in these comparisons. Authority — Scripture alone, or Scripture plus Tradition? Sacraments — channels of grace, or symbolic ordinances? Government — bishops, elders, or congregational autonomy? Baptism — infants or believers? Lord's Supper — real presence (in some sense) or memorial only? Worship — liturgical or free-form? Each tradition takes a position on most of these questions, and the positions tend to cluster historically and geographically.")
        ],
        pullQuotes: [],
        sources: [
            HistorySource(title: "List of Christian denominations", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/List_of_Christian_denominations", note: nil),
            HistorySource(title: "Christian denomination", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Christian_denomination", note: nil),
            HistorySource(title: "Global Christianity: A Report on the Size and Distribution of the World's Christian Population", author: "Pew Research Center", kind: .scholarly, url: nil, note: "Pew Research, 2011."),
            HistorySource(title: "World Christian Encyclopedia", author: "Todd M. Johnson and Gina A. Zurlo (eds.)", kind: .scholarly, url: nil, note: "Edinburgh University Press, 3rd ed., 2020.")
        ],
        related: ["denominations-overview", "denominations-restoration", "splits-reformation", "splits-1054"]
    )

    static let denominationsOverview = HistoryArticle(
        ...
        sources: [
            HistorySource(title: "Catholic Church", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Catholic_Church", note: nil),
            HistorySource(title: "Eastern Orthodox Church", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Eastern_Orthodox_Church", note: nil),
            HistorySource(title: "Protestantism", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Protestantism", note: nil),
            HistorySource(title: "The Orthodox Church", author: "Timothy (Kallistos) Ware", kind: .scholarly, url: nil, note: "Penguin, 1963; rev. 1993."),
            HistorySource(title: "The New Shape of World Christianity", author: "Mark A. Noll", kind: .scholarly, url: nil, note: "InterVarsity, 2009.")
        ],
        related: ["denominations-comparison", "denominations-restoration", "splits-1054", "splits-reformation"]
    )

    static let denominationsRestoration = HistoryArticle(
        ...
        sources: [
            HistorySource(title: "Restoration Movement", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Restoration_Movement", note: nil),
            HistorySource(title: "Churches of Christ", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Churches_of_Christ", note: nil),
            HistorySource(title: "Declaration and Address", author: "Thomas Campbell", kind: .primary, url: nil, note: "1809; reprinted in many anthologies of the movement."),
            HistorySource(title: "The Encyclopedia of the Stone-Campbell Movement", author: "Douglas A. Foster et al. (eds.)", kind: .scholarly, url: nil, note: "Eerdmans, 2004."),
            HistorySource(title: "Reviving the Ancient Faith: The Story of Churches of Christ in America", author: "Richard T. Hughes", kind: .scholarly, url: nil, note: "Eerdmans, 1996.")
        ],
        related: ["denominations-comparison", "denominations-overview", "practices-baptism", "practices-government"]
    )
}
