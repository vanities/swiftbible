...
Deno.serve(async (req) => {
  ...
  const query = `Create a daily devotional for a Bible app based on a random Bible verse, don't quote the NIV, only quote the KJV, NKJV, or the ESV.. Incorporate todays date: ${new Date()} into it, if it makes sense to. You can use markdown syntax to format the text.`;
