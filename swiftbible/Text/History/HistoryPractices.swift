//
//  HistoryPractices.swift
//  swiftbible
//
//  Section 5 — Practices Through History.
//

import Foundation

extension HistorySection {
    static let practices = HistorySection(
        id: "practices",
...
extension HistoryArticle {
    static let practicesBaptism = HistoryArticle(
        ...
        sources: [
            HistorySource(title: "Infant baptism", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Infant_baptism", note: nil),
            HistorySource(title: "Believer's baptism", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Believer%27s_baptism", note: nil),
            HistorySource(title: "Anabaptism", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Anabaptism", note: nil),
            HistorySource(title: "Apostolic Tradition", author: "Hippolytus of Rome", kind: .primary, url: nil, note: "c. 215 AD."),
            HistorySource(title: "Infant Baptism in the First Four Centuries", author: "Joachim Jeremias", kind: .scholarly, url: nil, note: "Westminster Press, 1962."),
            HistorySource(title: "Infant Baptism and the Covenant of Grace", author: "Paul K. Jewett", kind: .scholarly, url: nil, note: "Eerdmans, 1978.")
        ],
        related: ["denominations-restoration", "early-fathers"]
    )

    static let practicesLordsSupper = HistoryArticle(
        ...
        body: [
            ...
            .heading("Eastern Orthodox approach"),
            .paragraph("Eastern Orthodox Christians affirm a real change of the bread and wine into Christ's body and blood, but they generally avoid the philosophical language of transubstantiation. Orthodox theology prefers to call the Eucharist a mystery: real, transformative, but not exhaustively explainable in human categories."),
            .heading("Memorial in modern free churches"),
            .paragraph("Most Baptist, Pentecostal, Restoration Movement, and non-denominational churches today teach a memorial view. The Lord's Supper is observed (weekly in Restoration churches, monthly or quarterly in many Baptist churches) as a remembrance of Christ's sacrifice and a proclamation of his death until he returns. Within this view, the bread and cup are not less important — they remain central to worship — but their power lies in what they represent and recall, not in any change to the elements themselves."),
            .heading("Where the line falls"),
            .paragraph("The deepest question is whether the Lord's Supper is something Christ does for the believer (the sacramental view) or something the believer does in remembrance of Christ (the memorial view). Most traditions blend the two emphases to some degree. The label 'real presence' is shared by most Catholic, Orthodox, Anglican, Lutheran, and Reformed Christians, even when the precise mechanism is described differently. The 'memorial' view is shared by most Baptist, Pentecostal, Restorationist, and non-denominational Christians. Both sides find their interpretation compatible with the New Testament texts.")
        ],
        pullQuotes: [
            PullQuote(
        ...
        sources: [
            ...
            HistorySource(title: "Transubstantiation", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Transubstantiation", note: nil),
            HistorySource(title: "Memorialism", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Memorialism", note: nil),
            HistorySource(title: "First Apology, ch. 66", author: "Justin Martyr", kind: .primary, url: nil, note: nil),
            HistorySource(title: "Council of Trent, Session 13", author: nil, kind: .primary, url: nil, note: "1551 — Catholic dogmatic statement on the Eucharist."),
            HistorySource(title: "This Is My Body: Luther's Contention for the Real Presence in the Sacrament of the Altar", author: "Hermann Sasse", kind: .scholarly, url: nil, note: "Augsburg, 1959.")
        ],
        related: ["early-eucharist", "denominations-comparison"]
    )

    static let practicesGovernment = HistoryArticle(
        ...
        sources: [
            HistorySource(title: "Episcopal polity", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Episcopal_polity", note: nil),
            HistorySource(title: "Presbyterian polity", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Presbyterian_polity", note: nil),
            HistorySource(title: "Congregationalist polity", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Congregationalist_polity", note: nil),
            HistorySource(title: "Perspectives on Church Government: Five Views of Church Polity", author: "Chad Owen Brand and R. Stanton Norman (eds.)", kind: .scholarly, url: nil, note: "B&H Academic, 2004.")
        ],
        related: ["early-bishops", "denominations-comparison", "denominations-restoration"]
    )
}
