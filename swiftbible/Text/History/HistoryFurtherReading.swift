...
extension HistorySection {
    static let further = HistorySection(
        id: "further",
...
extension HistoryArticle {
    static let sourcesPrimary = HistoryArticle(
        id: "sources-primary",
        ...
        estimatedMinutes: 4,
        body: [
            .paragraph("One of the best ways to think clearly about church history is to read the original voices, not just summaries of them. Most of the major early Christian writings are available in English translation online for free, often in nineteenth-century translations that are still standard. The list below is a starting point, organized by author and where to find the texts."),
            .heading("Apostolic Fathers"),
            .paragraph("The earliest non-canonical Christian writings, dated roughly 70–150 AD. Translations of all of them are collected at New Advent (newadvent.org/fathers) and at the Christian Classics Ethereal Library (ccel.org)."),
            .list([
            ...
            .heading("Apologists & Theologians (2nd–4th centuries)"),
            .list([
            ...
            .heading("Reformation primary texts"),
            .list([
            ...
            .heading("Restoration Movement primary texts"),
            .list([
        ...
        pullQuotes: [],
        sources: [
            HistorySource(title: "New Advent: Church Fathers", author: nil, kind: .encyclopedia, url: "https://www.newadvent.org/fathers/", note: "Comprehensive online library of patristic writings in English."),
            HistorySource(title: "Christian Classics Ethereal Library", author: nil, kind: .encyclopedia, url: "https://ccel.org/", note: "Free public-domain Christian classics, primary and secondary."),
            HistorySource(title: "Early Christian Writings", author: nil, kind: .encyclopedia, url: "https://www.earlychristianwritings.com/", note: "Texts and scholarly commentary on early Christian and non-canonical writings.")
        ],
        related: ["sources-scholarly"]
    )

    static let sourcesScholarly = HistoryArticle(
        ...
        estimatedMinutes: 4,
        body: [
            .paragraph("The list below is a curated set of widely respected modern works on the topics covered in this History section. It is intentionally ecumenical — including Catholic, Orthodox, Protestant, and secular scholars — to give readers multiple angles on the same questions."),
            .heading("General church history"),
            .list([
            ...
            .heading("The Restoration Movement"),
            .list([
            ...
            .heading("Online encyclopedic sources"),
            .list([
        ...
        pullQuotes: [],
        sources: [
            HistorySource(title: "New Advent (Catholic Encyclopedia + Church Fathers)", author: nil, kind: .encyclopedia, url: "https://www.newadvent.org/", note: nil),
            HistorySource(title: "Christian Classics Ethereal Library", author: nil, kind: .encyclopedia, url: "https://ccel.org/", note: nil),
            HistorySource(title: "History of Christianity", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/History_of_Christianity", note: nil)
        ],
        related: ["sources-primary"]
    )
}
