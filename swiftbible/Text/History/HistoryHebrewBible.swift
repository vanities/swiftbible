//
//  HistoryHebrewBible.swift
//  swiftbible
//
//  Pre-NT Section — The Hebrew Bible & Texts.
//

import Foundation

extension HistorySection {
    static let hebrewBible = HistorySection(
        id: "hebrew-bible",
...
extension HistoryArticle {
    static let hebrewTanakh = HistoryArticle(
        id: "hebrew-tanakh",
        ...
        sources: [
            HistorySource(title: "Hebrew Bible", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Hebrew_Bible", note: nil),
            HistorySource(title: "Septuagint", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Septuagint", note: nil),
            HistorySource(title: "Development of the Hebrew Bible canon", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Development_of_the_Hebrew_Bible_canon", note: nil),
            HistorySource(title: "Invitation to the Septuagint", author: "Karen H. Jobes and Moisés Silva", kind: .scholarly, url: nil, note: "Baker Academic, 2nd ed., 2015."),
        ...
        related: ["hebrew-masoretic", "hebrew-dead-sea", "origins-canon-process"]
    )

    static let hebrewMasoretic = HistoryArticle(
        id: "hebrew-masoretic",
        ...
        sources: [
            HistorySource(title: "Masoretic Text", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Masoretic_Text", note: nil),
            HistorySource(title: "Aleppo Codex", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Aleppo_Codex", note: nil),
            HistorySource(title: "Leningrad Codex", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Leningrad_Codex", note: nil),
            HistorySource(title: "Textual Criticism of the Hebrew Bible", author: "Emanuel Tov", kind: .scholarly, url: nil, note: "Fortress Press, 3rd ed., 2012.")
        ],
        related: ["hebrew-tanakh", "hebrew-dead-sea"]
    )

    static let hebrewDeadSea = HistoryArticle(
        id: "hebrew-dead-sea",
        ...
        sources: [
            HistorySource(title: "Dead Sea Scrolls", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Dead_Sea_Scrolls", note: nil),
            HistorySource(title: "Biblical apocrypha", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Biblical_apocrypha", note: nil),
            HistorySource(title: "Pseudepigrapha", author: nil, kind: .encyclopedia, url: "https://en.wikipedia.org/wiki/Pseudepigrapha", note: nil),
            HistorySource(title: "The Meaning of the Dead Sea Scrolls", author: "James VanderKam and Peter Flint", kind: .scholarly, url: nil, note: "HarperOne, 2002."),
            HistorySource(title: "The Old Testament Pseudepigrapha", author: "James H. Charlesworth (ed.)", kind: .scholarly, url: nil, note: "Doubleday, 2 vols., 1983/1985.")
        ],
        related: ["hebrew-tanakh", "hebrew-masoretic", "intertest-sects", "origins-disputed-books"]
    )
}
