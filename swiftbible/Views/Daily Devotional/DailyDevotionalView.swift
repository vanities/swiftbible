...
struct DailyDevotionalView: View {
    ...
    private var devotionalBadge: some View {
        if devotionalType == "custom" {
            ...
            AIGeneratedBadge(
                message: "This devotional was generated by GPT-5.4 via OpenAI. Large language models can make mistakes, produce inaccurate information, or generate content that may not align with biblical teaching. Always verify important information and consult trusted sources."
            )
        }
    }
