...
struct DailyDevotionalView: View {
    ...
    private var devotionalBadge: some View {
        if devotionalType == "custom" {
            ...
            AIGeneratedBadge(
                message: "This devotional was generated by GPT-5.4 via OpenAI, weaving together verses from two thematically connected Bible books. Large language models can make mistakes, produce inaccurate information, or generate content that may not align with biblical teaching. Always verify important information and consult trusted sources.",
                symbolName: "sparkles",
                primaryTint: .cyan,
                secondaryTint: .blue
            )
            ...
            AIGeneratedBadge(
                message: "This devotional was generated by GPT-5.4 via OpenAI from a single Bible verse. Large language models can make mistakes, produce inaccurate information, or generate content that may not align with biblical teaching. Always verify important information and consult trusted sources.",
                symbolName: "sparkle",
                primaryTint: .yellow,
    ...
    private func holidayBadge(name: String) -> some View {
        ...
        .alert(name, isPresented: $showHolidayDisclosure) {
            ...
            Text("This devotional was generated by GPT-5.4 in honor of \(name). Large language models can make mistakes — verify important information and consult trusted sources.")
        }
    }
