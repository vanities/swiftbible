            ...
            HStack(spacing: 12) {
                ...
                if devotionalType == "custom" {
                    Label("Custom", systemImage: "pencil.and.scribble")
                        ...
                        .accessibilityLabel("Custom devotional")
                } else {
                    AIGeneratedBadge(message: "This devotional was generated by GPT-5.4 via OpenAI. Large language models can make mistakes, produce inaccurate information, or generate content that may not align with biblical teaching. Always verify important information and consult trusted sources.")
                }
            }
            .padding(.horizontal)
            .padding(.top)
